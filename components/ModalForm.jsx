...
export default function ModalForm() {
  const [showModal, setShowModal, textColor] = React.useState(false);
  return (
    <>
      <button
        className=" text-`${textColor}`  text-base shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 text-4xl hover:text-gray-500"
        type="button"
          ...
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-4/5 my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                {/*body*/}
                <div className="relative p-6 flex  text-black">
                  <form>
                    <p className="text-black text-xl">
                      Uno de nuestros asesores se pondrá en contacto contigo
                      para asesorarte con una solución más rentable y útil para
                      tu empresa
                    </p>
                    <br />
                    ...
                    <div className="relative z-0 mb-6 w-full group">
                      ...
                      <label
                        ...
                        className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                      >
                        Dirección donde se requiere el servicio
                      </label>
                    </div>
                    <div className="relative z-0 mb-6 w-full group">
                      <input
