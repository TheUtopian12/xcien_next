                ...
                <Drawer isOpen={isOpen} setIsOpen={setIsOpen} titulo="TP-LINK">
                  <div className="p-4">
                    ...
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 text-justify">
                      Su uso es adecuado para pasar corriente eléctrica a 5
                      aparatos diferentes desde una misma toma corriente. Cuenta
                      con 5 contactos aterrizados, 2 puertos USB para pasar
                      energía a celulares, tabletas y otros dispositivos
                      móviles, incluye protección de 1,000 joules y switch reset
                      iluminado de 10 Amperes. Su cable mide 45 cm, cuenta con
                      clavija de alimentación de 90 grados y orificios para
                      montar a la pared.
                    </p>
