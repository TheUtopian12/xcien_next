        ...
        <div className="flex items-center justify-center h-screen  bg-center bg-cover custom-img3">
          <div className="p-5 text-white z-[2] text-center  ">
            ...
            <span className="text-5xl ">
              <br /> <strong>INTERNET RESIDENCIAL PLUS</strong> <br />
            </span>
            <p className="pt-10 text-3xl">
            Servicio de conexión ideal para emprendedores, trabajo en casa o 
            <br />
            usuarios exigentes que requieren un servicio de Internet en casa
            </p>
      ...
      <section>
        <div className="flex items-left justify-center h-screen mt-48  bg-center bg-cover custom-img4">
          <div className="p-5 text-white z-[2] text-left mt-48 ">
            {" "}
            <span className="text-5xl ">Asimétrico</span>
            <p className="pt-10 text-3xl">SLA: 99%</p>
            <p className="pt-10 text-3xl">Velocidad: 10 Mbps y 20 Mbps</p>
            <p className="pt-10 text-3xl">Instalación hasta 7 días
