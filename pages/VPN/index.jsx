  ...
  return (
    <div className={style.container1}>
      ...
      <div className="flex-row items-center justify-center bg-white">
        ...
        <button
          type="button"
          class="text-black hover:text-white relative left-1/3 bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-white dark:hover:bg-green-700 dark:focus:ring-green-800"
        >
          Más Información
          <svg
            aria-hidden="true"
